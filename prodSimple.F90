SUBROUTINE production(pa, harvest, loop, time, prod, paraT, paraFrac, &
                      bal1, bal2, bal3)
...
! n is #/m3
   ...
   DOUBLE PRECISION, INTENT(INOUT) :: harvest, prod, paraT, paraFrac 
   DOUBLE PRECISION, INTENT(INOUT) :: bal1, bal2, bal3
...
!====================================================================
SUBROUTINE TEP_prod(p, organic, harvest, TEP_f, paraT, paraFrac)
   USE the_info

   TYPE(agg_part), INTENT(INOUT) :: p
   DOUBLE PRECISION, INTENT(INOUT) :: harvest, organic, TEP_f, paraT, paraFrac
...
! change moles to volume
   ...
   CALL fractal_dimension(p, paraFrac)
   CALL density(p,paraFrac)
